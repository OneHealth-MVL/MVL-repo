...
model HI
global{
	/*======| Scenario:  High Introduction equal effect |==========
	 * 0 = Baseline
	...
	// ===========| Disease Parameters |=========
	 ...
	 float Introduction_p <- 0.15; // Baseline 0.01(0.05, 0.1)
	 ...
	 // ~~~~~~Vaccination~~~~~
     float Vaccination_OR_S <- 0.0493; // (M=0.0441, P=0.0434)
	 float Vaccination_OR_R <- Vaccination_OR_S; //(M=0.1357, P=0.0619)
	 float p_vaccination_res <- 0.5;
	 float p_vaccination_staff <- 0.5;
